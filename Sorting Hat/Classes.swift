        ...
        self.questions = [
            1: SortingQuestion(question: "Which of these have you thought the most since the Sorting began?", choices: [
                SortingQuestion.SortingQuestionChoice(id: "not Slytherin", choiceText: "Not Slytherin, not Slytherin...", choiceScoresForDestinations: [
                    ScoreForDestination(destination: self.destinations["Gryffindor"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: -2),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: -1),
                ...
                SortingQuestion.SortingQuestionChoice(id: "miss Obama", choiceText: "I miss Obama.", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: 0...2)),
                ...
                SortingQuestion.SortingQuestionChoice(id: "kid's books", choiceText: "Harry Potter is for kids.", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: 0...2))
                ]),
            ...
            2: SortingQuestion(question: "Who is your favorite Beatle?", choices: [
                SortingQuestion.SortingQuestionChoice(id: "john", choiceText: "John Lennon", choiceScoresForDestinations: [
                    ScoreForDestination(destination: self.destinations["Gryffindor"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: 0...2))
                ]),
                SortingQuestion.SortingQuestionChoice(id: "paul", choiceText: "Paul McCartney", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: 0...2)),
                ...
                SortingQuestion.SortingQuestionChoice(id: "george", choiceText: "George Harrison", choiceScoresForDestinations: [
                    ScoreForDestination(destination: self.destinations["Gryffindor"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                ...
                SortingQuestion.SortingQuestionChoice(id: "ringo", choiceText: "Ringo Starr", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: 0...2)),
            ...
            3: SortingQuestion(question: "What would you prefer to do during a quidditch game?", choices: [
                ...
                SortingQuestion.SortingQuestionChoice(id: "ref", choiceText: "Be the Referee!", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: 0),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: 0),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: 0),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: -1),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: 0),
                ...
                SortingQuestion.SortingQuestionChoice(id: "what", choiceText: "What's quidditch?", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: 0),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: 0),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: 2...4)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: 1...3))
                ])
            ]),
            4: SortingQuestion(question: "Which of these numbers is the most magical?", choices: [
                SortingQuestion.SortingQuestionChoice(id: "c", choiceText: "299,792,458", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: 2...4)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: 2...4))
                ]),
                ...
                SortingQuestion.SortingQuestionChoice(id: "seven", choiceText: "7", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: -1...1))
                ]),
                ...
                SortingQuestion.SortingQuestionChoice(id: "nine", choiceText: "IX", choiceScoresForDestinations: [
                    ScoreForDestination(destination: self.destinations["Gryffindor"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: 2...4)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: 2...4))
                ]),
            ...
            5: SortingQuestion(question: "Which of these drinks do you like best?", choices: [
                ...
                SortingQuestion.SortingQuestionChoice(id: "butter beer", choiceText: "Butter Beer", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: 0),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: 0),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: 0)
                ...
                SortingQuestion.SortingQuestionChoice(id: "enemy tears", choiceText: "The tears of my enemies", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: 0...3)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: -3...0)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: -3...0)),ScoreForDestination(destination: self.destinations["Gryffindor"]!, score: -1),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: 3),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: -3...0)),
                ...
                SortingQuestion.SortingQuestionChoice(id: "apple juice", choiceText: "Apple Juice", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: 0...3)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: -1...1))
                ]),
            ...
            6: SortingQuestion(question: "Which of these would you prefer as your wand core?", choices: [
                SortingQuestion.SortingQuestionChoice(id: "phoenix feather", choiceText: "A phoenix feather", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: -1...1))
                ]),
                ...
                SortingQuestion.SortingQuestionChoice(id: "malabrigo", choiceText: "Malabrigo wool", choiceScoresForDestinations: [
                    ...
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: 0...2)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: 1...3)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: -2...0)),
                ...
                SortingQuestion.SortingQuestionChoice(id: "apple A14X", choiceText: "An A14X cpu", choiceScoresForDestinations: [
                    ScoreForDestination(destination: self.destinations["Gryffindor"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Ravenclaw"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Hufflepuff"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Slytherin"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Hogwarts Headmaster"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Dumbledore's Army"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Death Eater"]!, score: Int.random(in: -2...0)),
                    ScoreForDestination(destination: self.destinations["Muggle"]!, score: Int.random(in: 2...4)),
                    ScoreForDestination(destination: self.destinations["Jedi"]!, score: Int.random(in: -1...1)),
                    ScoreForDestination(destination: self.destinations["Sith"]!, score: Int.random(in: -1...1))
                ]),
